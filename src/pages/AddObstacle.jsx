...
export default function AddObstacle() {
  ...
  const filteredObstacles = obstacles.filter((obstacle) => {
    if (filter === 'solved') return obstacle.solved;
    if (filter === 'unsolved') return !obstacle.solved;
    return true;
  });
    ...
    <div className="flex h-screen w-screen">
      ...
      <div className="flex flex-col w-full p-4 bg-[#FFF]">
          ...
          <button
            className={`py-2 px-6 rounded-md ${
              view === 'add'
                ...
                : 'bg-[#1A2342] text-gray-200 hover:bg-blue-500 hover:text-white'
            } border border-[#101A33]`}
        ...
        <div className="flex flex-grow items-center justify-center">
          {view === 'add' && (
            <div className="bg-blue-700 flex flex-col justify-center items-center rounded-md p-4 max-w-lg w-full h-[500px] mt-4">
              ...
              <form className="w-full" onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <label className="block text-white mb-1" htmlFor="road">
                    Road
                  </label>
                  <input
                    id="road"
                ...
                <div className="mb-4">
                  <label className="block text-white mb-1" htmlFor="locationInfo">
                    Additional Info
                  </label>
                  <input
                    id="locationInfo"
          ...
          {view === 'list' && (
            <div className="bg-blue-700 flex flex-col rounded-md p-4 max-w-4xl w-full mt-4 overflow-y-auto h-[calc(100vh-150px)]">
                ...
                <button
                  className={`py-2 px-4 rounded-md ${
                    filter === 'all'
                      ...
                      : 'bg-gray-500 text-white hover:bg-green-500'
                  }`}
                ...
                <thead>
                  ...
                  <tbody>
                    {filteredObstacles.map((obstacle) => (
                      <tr key={obstacle.id} className="border-b border-gray-300 hover:bg-blue-600 transition duration-200">
                        ...
                        <td className="px-4 py-2">
                          {obstacle.solved ? (
                            <span className="bg-green-500 text-white px-2 py-1 rounded-md">Solved</span>
                          ) : (
                            <span className="bg-red-500 text-white px-2 py-1 rounded-md">Unsolved</span>
                          )}
                        </td>
